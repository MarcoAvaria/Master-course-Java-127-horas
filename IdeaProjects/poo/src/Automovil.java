public class Automovil implements Comparable<Automovil>{
    ...
    public String verDetalle(){
        ...
        if (getRuedas() != null) {
            ...
            for (Rueda r : this.getRuedas()) {
                detalle += "\n" + getFabricante() + ", aro: " + r.getAro() + ", ancho: " + r.getAncho();
            }
        }
        return detalle;
    }
    ...
    }//En funciones static solo se pueden usar variables/funcion static, en este caso no se puede usar capacidadEstanqu
