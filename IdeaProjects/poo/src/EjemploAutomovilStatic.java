...
public class EjemploAutomovilStatic {
    public static void main(String[] args) {
        ...
        System.out.println("Kilómetro por litro = " + Automovil.calcularConsumoEstatico(300,60));
        ...
        System.out.println("tipoSubaru.getNumeroPuerta() = " + tipoSubaru.getNumeroPuerta());
